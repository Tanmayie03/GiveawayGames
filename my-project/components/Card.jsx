...
export default function Card(props) {
  return (
    <div className="text-white border-2 rounded-md shadow-md hover:bg-stone-950 border-stone-900 bg-stone-800 h-fit bg-opacity-70 w-80 card">
      <div key={props.id}>
        <img
          src={props.thumbnail}
          alt={props.title}
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center py-1 rounded w-fit ">
              <span className="text-gray-400 line-through ">{props.worth}</span>
